...
export const metadata: Metadata = {
	title: "Privacy Policy - NextMoney Composer",
	description:
		"Learn how NextMoney Composer handles your data and privacy. Our commitment to protecting your information while you edit videos.",
	openGraph: {
		title: "Privacy Policy - NextMoney Composer",
		description:
			"Learn how NextMoney Composer handles your data and privacy. Our commitment to protecting your information while you edit videos.",
	...
	return (
		...
		>
			...
			<section className="flex flex-col gap-3">
				...
				<p>NextMoney Composer integrates with these services:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					NextMoney Composer is completely open source. You can review our code, see exactly
